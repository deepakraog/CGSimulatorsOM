...
<%!String msg = "";
	...
	public boolean nullLength(String key, String str, boolean mandatory,
			int length) {
...
<%
	...
	try {
		...
		else
		{
			...
			System.out.println("dcurl : "+dcurl);
			...
			<tr>
				<td>
					<div
						...
						<!-- <a href="/Idea/ConsentIdeaPPU?srurl=<%=redirecturl%>&msisdn=<%=request.getHeader("x-msisdn")%>&mode=WAP"> Accept </a> -->
					</div>
				</td>
