...
public class ConsentIdeaSub extends HttpServlet {
	...
	public void doProcess(HttpServletRequest request,HttpServletResponse response) throws Throwable
	{
		...
		String url = actURL+msisdn+"&siteid=1&Type=P&action=ACT&User=mmp&Pass=mmp&remarks=ACTIVATION&srvkey="+srvkey+"&mode="+mode+"&Refid="+refid+"&info="+info+"&originator=&status=SUCCESS&price=10";
