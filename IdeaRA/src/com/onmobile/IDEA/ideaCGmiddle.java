...
public class ideaCGmiddle extends HttpServlet {
	...
	public void doProcess(HttpServletRequest request,HttpServletResponse response) throws Throwable
	{
		...
		String actURL = (String) util.get("IDEA_RA_CONSENT_URL");
		String url = actURL+srurl+"&msisdn="+msisdn+"&srvkey="+srvkey+"&action=yes&refid="+refid+"&mode=wap&info="+info+"&rurlD="+rurlD+"&originator="+originator;
